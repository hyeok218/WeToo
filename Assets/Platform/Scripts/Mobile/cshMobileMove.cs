...
public class cshMobileMove : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        cshJoyStick = GetComponentInChildren<cshJoyStick>();
    }
    ...
    void Update()
    {
        ...
        //--- 이동 ----
        // 1. 사용자의 입력에 따라
        float h = cshJoyStick.GetHorizontalValue();
        float v = cshJoyStick.GetVerticalValue();
    ...
    //1인칭 3인칭 시점변경, 버튼으로 호출
    public void SetCameraView()
    {
        if (CamState) // 1인칭 --> 3인칭
        {
            CamState = false;
            //CameraCenter.GetComponent<cshFPCameraMobile>().rotSpeed = TPRotSpeed;
        ...
        {
            CamState = true;
            //CameraCenter.GetComponent<cshFPCameraMobile>().rotSpeed = FPRotSpeed;
